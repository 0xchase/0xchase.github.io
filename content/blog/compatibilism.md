...
<explain possible positions>

The primary contribution of this essay is to the compatibilism/incompatibilism debate. I'll briefly cover why determinism must be true in order to modivate and contextualize the rest of my discussion, but I won't be saying anything novel about it - I consider it to be basically a closed matter and libertariaism to be a dead position, so my attention will be focused elsewhere.
...
Like many perennial problems in philosophy, the issue of free will is one where disagreement about the meanings of the key terms is a central issue. While the above picture *seems* to threatning to human freedom, it's going to depend on exactly how we define it. Some definitions offered by philosophers are compatible with determinism. To some extent this is a semantic issue - some concepts of free will are incompatible with determinism and therefore unreal, and some weaker concepts of free will are compatible with determinism and real, and that's all that can be said. But surely how people normally conceptialize their own freedom matters?
...
When deciding if a concept like freedom is real, it’s tempting to start with an intensional, and to look for anything in the world that satisfies the specified conditions. The case of the Aristotelian physicist shows that this is not always the right strategy, and that in deciding whether free will is *real*, we should look at the *referent* of the term to see if it refers to something.

## Folk Psychology

### Folk Psychology

When I say that part of the problem is a pre-scientific theory of mind, I'm referring to what psychologists and philosophers have often called "folk psychology".

 - Folk theory of the world
   - Here’s a rough sketch of how this theory works
   - First, a simple binary, there’s the self vs. the external word
   - The external world is filled with objects and agents
   - Note that this division isn’t real as a fundamental ontological category, they’re just a way we model the world
   - Our minds categorize the world into the subjective, objective, etc. It does not follow that the world actually is this way.
   - A failure to recognize that this division is a matter of how we represent the world, has led to many confusions in the history of philosophy
   - Has led to the reification of the mental as a fundamental ontological category, like the idealists who debate whether the composition of the world is mental or not

 Here’s a rough sketch of the theory. First, there’s a simple division between the self, which is populated with thoughts, feelings, sensations, etc, and the external world, which is populated with objects. These objects may be classified according to their properties, and one of the most important classes is that of agents.
...
### Decisions
 ...
 - One aspect of this theory is our theory of the will
...
The confusions start to set in when we mix this naive theory of how our minds work with other facts established by science. We'll see how these confusions are widespread.
